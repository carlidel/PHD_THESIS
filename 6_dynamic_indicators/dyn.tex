...
\subsection{Models}
%
To test the effectiveness of the proposed indicators of chaos, we consider a $4d$ polynomial symplectic map dependent on time, which is a generalization of the Hénon map~\cite{Yellow}. The origin is an elliptic fixed point, and the nonlinear terms combine fixed quadratic nonlinearities and variable cubic ones. The map reads:
%\begin{widetext}
\begin{equation}
    \begin{split}
    \left(\begin{array}{c}

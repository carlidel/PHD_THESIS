...
%        \bottomrule
%    \end{tabular}
%    \caption{Performance scores achieved by the dynamic indicators for the various Hénon map configurations, evaluated using Eq.~\eqref{eq:final_evaluation} over the interval $n=10^4-10^8$. It can be seen how $GALI^{(4)}$ and $REM$ archives the higher scores consistently.  \textcolor{red}{DECIDETE VOI QUALE DELLE DUE TENERE}}
%    \label{table:values}
%\end{table*}

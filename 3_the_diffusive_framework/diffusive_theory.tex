...
After having introduced the basic concepts of the theory of stochastic Hamiltonian systems in Chapter~\ref{ch:mathematical_elements}, we now turn to the study of the diffusive properties of these systems. These properties are related to the introduction of a stochastic perturbation in the Hamiltonian describing the system under consideration. The framework we review here for the application of the averaging principle on stochastic Hamiltonian systems follows the line of work presented in~\ref{Bazzani9948, Bazzani:2019lse, bazzani2020diffusion}.

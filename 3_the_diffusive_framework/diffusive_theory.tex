...
The latest diffusion measurements, based on~\cite{stancari2011diffusion} diffusive framework, were taken during LHC Run~2~\cite{Valentino:2280928}, and provided a consistent amound of collimator scan data which provided an overview of the halo diffusive phenomenology~\cite{PhysRevAccelBeams.23.044802}.  

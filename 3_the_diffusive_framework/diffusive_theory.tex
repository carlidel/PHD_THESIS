...
Let us consider a generic 1\textsc{d} stochastically perturbed Hamiltonian system in action-angle coordinates, with the origin $I=0$ being an elliptic point of \(\ham_0\). The Hamiltonian reads
\begin{equation}

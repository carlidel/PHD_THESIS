...
If instead we are considering a noise characterised by a specific spectrum, also referred to as coloured noise, we can consider its Fourier expansion, which reads
\begin{equation}
